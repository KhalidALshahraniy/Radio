class Player{
    constructor(){
        ...
        this.audios[1] = "https://n0e.radiojar.com/x0vs2vzy6k0uv?rj-ttl=5&rj-tok=AAABhr1jhO8A_1YXGrhiANtk1g";
        this.audios[2] = "https://backup.qurango.net/radio/maher";
    
        this.names = [];
        this.names[0] = "اذاعة قران";
        this.names[1] = "اذاعة حديث";
        this.names[2] = "تلاوات";
